...

{
    ...
    "assets": {
        ...
        "web.assets_backend": [
            ...
            # CSS/SCSS files - loaded early for styling
            ...
            # XML templates MUST load before JavaScript that depends on them
            # Order is critical for template inheritance
            "web_responsive/static/src/legacy/xml/form_buttons.xml",
            "web_responsive/static/src/legacy/xml/custom_favorite_item.xml",
            
            # Component templates (loaded with components)
            ...
            # JavaScript files AFTER templates to avoid dependencies issues
